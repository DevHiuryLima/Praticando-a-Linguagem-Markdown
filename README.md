...
OBS: O rodapé não pode ser colocado dentro de outros elementos Markdown como, tabelas, listas e blocos de código. As notas de rodapé serão, sempre, sequenciais, independente dos identificadores que você criou, por exemplo uma sequência de notas ```[^35,], [^aaaa] e [^102_444] ``` e será renderizada como 1, 2 e 3.
---
